...
-- This is hacked version for murgaLua
-- Original here - http://github.com/fab13n/metalua/tree/no-dll/src/lib/serialize.lua

-- Moved to the murgaLua namespace

function murgaLua.serialize (x)
